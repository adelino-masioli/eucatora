<div class="row">
    ...
    <div class="tab-content">
        <div role="tabpanel" class="tab-pane fade in active" id="tab_provider">@include('Sales::partial.tabs.provider')</div>
        @if(isset($products))
            <div role="tabpanel" class="tab-pane fade" id="tab_itens">@include('Sales::partial.tabs.itens')</div>
            <div role="tabpanel" class="tab-pane fade" id="tab_taxes">@include('Sales::partial.tabs.taxes')</div>
        @endif
    </div>
</div>