<div class="col-lg-12">
    <div class="panel panel-default">
        <div class="panel-heading text-uppercase"><strong>Itens da venda</strong></div>
        <div class="panel-body">
            <div class="row">
                ...
                <div class="form-group col-lg-1">
                    ...
                    {!! Form::text('amount_item', null, array('id'=>'amount_item', 'class'=>'form-control input-sm', 'placeholder'=>'Qtd', 'onclick'=>'onlyNumber(\'#amount\')')) !!}
                </div>
                <div class="form-group col-lg-1">
    ...
    <div class="panel panel-success">
        <div class="panel-heading text-uppercase"><strong>Listagem de itens da venda</strong></div>
