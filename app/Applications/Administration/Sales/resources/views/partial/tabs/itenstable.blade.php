<table class="table table-condensed table-responsive table-striped table-hover table-bordered">
    <thead>
        <tr>
            ...
            <th class="col-md-1 text-center text-capitalize">COMPRIMENTO</th>
    ...
    <tfoot>
        ...
        <tr>
            <th colspan="3" class="col-md-1 text-right text-capitalize"></th>
            <th colspan="3" class="col-md-1 text-right text-capitalize"><p style="position:relative; top: 6px;">VALOR À VISTA 5% DE DESCONTO</p></th>
            <th colspan="2" class="col-md-1 text-right text-capitalize">
                <div class="row">
                    <div class="form-group col-lg-12" style="margin-bottom: 0px!important;">
                        <div class="input-group input-group-sm">
                            {!! Form::text('discount', null, array('id'=>'discount', 'class'=>'form-control input-sm text-right', 'placeholder'=>'Desconto')) !!}
                            <span class="input-group-btn">
                            <button class="btn btn-warning" type="button" onclick="addDiscount('{{url('dashboard/sale/updatediscount')}}');"><i class="fa fa-usd" aria-hidden="true"></i></button>
                      </span>
                        </div>
                    </div>
                </div>
        ...
        <tr>
            <th colspan="3" class="col-md-1 text-right text-capitalize"></th>
            <th colspan="3" class="col-md-1 text-right text-capitalize">VALOR DO DESCONTO</th>
            <th colspan="2"  class="col-md-1 text-right text-capitalize" id="tbl_desconto">0.00</th>
        </tr>

        <tr>
            <th colspan="5" class="col-md-1 text-right text-capitalize"></th>
            <th colspan="1" class="col-md-1 text-right text-capitalize">TOTAL</th>
            <th colspan="2"  class="col-md-1 text-right text-capitalize" id="tbl_total">{{$price_total ? AppHelper::money_br($price_total - $sale->price_shipp - $sale->discount) : '0.00'}}</th>
        </tr>
    </tfoot>
</table>