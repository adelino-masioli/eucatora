<table class="table table-condensed table-responsive table-striped table-hover table-bordered">
    ...
    <tbody id="showResultPayments">
        ...
        <tr>
            ...
            <td class="col-md-6 text-center">{{$sales_payment->sale_pay_type}}</td>
            <td class="col-md-1 text-left">{{$sales_payment->sale_pay_number}}</td>
            <td class="col-md-2 text-center">{{$sales_payment->sale_pay_value}}</td>
